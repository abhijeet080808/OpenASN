                         ...
                         const std::string& typeReference)
{
  ...
  ss_hdr << "#pragma once\n"
         ...
         << "      bool EncodeBER(std::vector<char>& buffer);\n"
         << "      // Dequeues and decodes bytes from vector\n"
         << "      bool DecodeBER(std::vector<char>& buffer);\n"
         << "\n"
         << "    private:\n"
         << "      bool mValue;\n"
         << "  };\n"
  ...
  ss_cpp << "#include \"" << typeReference << ".hh\"\n"
         ...
         << "bool\n"
         << typeReference << "::\n"
         << "EncodeBER(std::vector<char>& buffer)\n"
         << "{\n"
         ...
         << "bool\n"
         << typeReference << "::\n"
         << "DecodeBER(std::vector<char>& buffer)\n"
         << "{\n"
         << "  if (buffer.size() < 3)\n"
         << "  {\n"
         << "    return false;\n"
